...
namespace DATN_TMS.Areas.GV_BoMon.Controllers
{
    ...
    public class ChamDiemBaoCaoController : Controller
    {
        ...
        // GET: /GV_BoMon/ChamDiemBaoCao/Detail/{id}
        ...
        // GET: /GV_BoMon/ChamDiemBaoCao/ChamDiem/{phienBaoVeId}
        ...
        // POST: /GV_BoMon/ChamDiemBaoCao/LuuDiem
        [HttpPost]
        ...
        // POST: /GV_BoMon/ChamDiemBaoCao/ThuKyDieuChinhDiem
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // POST: /GV_BoMon/ChamDiemBaoCao/ChuTichXacNhan
        [HttpPost]
        [ValidateAntiForgeryToken]
        ...
        // GET: /GV_BoMon/ChamDiemBaoCao/BangDiemTongHop/{phienBaoVeId}
        ...
        // API kiểm tra có hội đồng không
        [HttpGet]
